...
<div class="page-content">
    <div class="page-header">
                 ...
                 <div class="row">
                    <div class="col-xs-12">
                           <div  class="table-responsive student-table" style="margin-top: -20px;">
                                <table class="table table-striped table-bordered table-hover table-full-width" id="pedding-table">
                                   <thead>
                                      <th class="center">
                                            <label class="pos-rel">
     ...
     <script>        
      ...
      $('body').on('dblclick',"#pedding-table tbody tr",function(){
        //$(".overlay").show();
