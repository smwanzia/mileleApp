...
<div class="page-content">
    <div class="page-header">
                 ...
                 <div class="row">
                    <div class="col-xs-12">
                           <div  class="table-responsive student-table" style="margin-top: -20px;">
                                <table class="table table-striped table-bordered table-hover table-full-width" id="approved-table">
                                   <thead>
                                      <th class="center">
                                            <label class="pos-rel">
                                    ...
                                    <tbody>
                                     <?php if(!empty($approved)){ foreach($approved as $row){ ?>
     ...
     <script>        
      ...
      $('body').on('dblclick',"#approved-table tbody tr",function(){
        //$(".overlay").show();
