...
<div class="page-content">
    <div class="page-header">
                 ...
                 <div class="row">
                    <div class="col-xs-12">
                           <div  class="table-responsive student-table" style="margin-top: -20px;">
                                <table class="table table-striped table-bordered table-hover table-full-width" id="registeredmembers">
                                   <thead>
                                      <th class="center">
                                            <label class="pos-rel">
                                    ...
                                    <tbody>
                                     <?php if(!empty($members)){ foreach($members as $row){ ?>
                                        <tr membersid="<?= $row->MEMBER_ID ?>" title="double click to view more">
                                                 <td class="center">
                                                      <label class="pos-rel">
                                                  ...
                                                  <td><?= $row->PHONE ?></td>
                                                  <td><?= $row->SCHEME_NAME."," ?> <?= $row->SCHEME_TYPE_NAME ?></td>
     ...
     <script>        
      ...
      $('body').on('dblclick',"#registeredmembers tbody tr",function(){
        //$(".overlay").show();
