...
<div class="page-content">
        ...
        <div class="row">
            <div class="col-xs-12">
                 <div class="row">
                    <div class="col-xs-12">
                       <form class="form-inline" id="marksform" action="index.php/Exams/AddMarks" method="post">
                                     ...
                                     <?php if(!empty($student_marksheet)){ foreach($student_marksheet as $row){ ?>
                                            ...
                                            <tr studentid="">
                                                     <td class="center">
                                                      ...
                                                      <td><input type="text" id="marks" name="marks[]" class="form-control input-sm"></td>
                                             </tr>
                   ...
                   //j data.push({"CLASSID": "FORM 1"});
                    ...
                    $.ajax({
                      ...
                      success:function(data){
                           ...
                           $("#marksform input[name=marks]").each(function(){
                               $(this).val("");
                           })
