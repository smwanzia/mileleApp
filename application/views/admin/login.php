...
<html lang="en">
  ...
  <body class="login-layout">
            ...
            <div class="login-container">
              <div class="center">
                <h1>
                  ...
                  <span class="red">Milele</span>
                  <span class="white" id="id-text2">Services</span>
                </h1>
                <h4 class="blue" id="id-company-text">&copy;Milele</h4>
              </div>
                ...
                <div id="login-box" class="login-box visible widget-box no-border">
                  <div class="widget-body">
                    <div class="widget-main">
                      ...
                      <form action="<?php echo base_url("Account/login") ?>" class="form-login" method="post">
                        <fieldset>
                                ...
                                <div class="clearfix">
                                  ...
                                  <button type="submit" id="submit_btn" class="width-35 pull-right btn btn-sm btn-primary">
                      ...
                      <div class="social-or-login center">
                        <span class="bigger-110">©<?php echo date('Y')?> milele limited services</span>
                      </div>
    ...
    <script src="<?php echo base_url();?>assets/admin-assets/js/jquery.validate.min.js"></script>
