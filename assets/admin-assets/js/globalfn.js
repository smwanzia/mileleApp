 ...
 */
 ...
 //var base_url="http://localhost/mileleApp";
    function GenericLoad(controller,method,loadat,data)
    {

        $(".overlay").fadeOut();  //load loader
        ...
        $(loadat).load(base_url+"/"+controller+"/"+method+"/"+data);   
          ...
          success: function(data){
               if(data=="success"){
                     sweetAlert({
                        ...
                        type:"success",
                        onClose:function(){
                                $.get("<?php echo base_url();?>index.php/"+Controller+"/"+loadto,{},function(user){
                                    $(".main-content-innerr").html(user);
...
//generic delete
function GenericDeletess(id,controller,method,loadat){
                ...
                data:{id:id},
                  ...
                  if(data=="success"){
                     sweetAlert({
                        ...
                        type:"success",
                        onClose:function(){
                                $.get("<?php echo base_url();?>index.php/"+Controller+"/"+loadat,{},function(user){
                                    $(".main-content-innerr").html(user);
